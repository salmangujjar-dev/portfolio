...
const SvgNodeJs = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <defs>
      ...
      <clipPath id="node-js_svg__a">
        <path d="m239.03 226.605-42.13 24.317a5.09 5.09 0 0 0-2.546 4.406v48.668c0 1.817.968 3.496 2.546 4.406l42.133 24.336a5.1 5.1 0 0 0 5.09 0l42.126-24.336a5.1 5.1 0 0 0 2.54-4.406v-48.668c0-1.816-.97-3.496-2.55-4.406l-42.12-24.317a5.12 5.12 0 0 0-5.1 0" />
      </clipPath>
      <clipPath id="node-js_svg__c">
        <path d="M195.398 307.086c.403.523.907.976 1.5 1.316l36.14 20.875 6.02 3.46c.9.52 1.926.74 2.934.665q.506-.042 1-.183l44.434-81.36c-.34-.37-.738-.68-1.184-.94l-27.586-15.93-14.582-8.39a5.3 5.3 0 0 0-1.32-.53zm0 0" />
      </clipPath>
      <clipPath id="node-js_svg__e">
        <path d="M241.066 225.953a5.1 5.1 0 0 0-2.035.652l-42.01 24.247 45.3 82.51c.63-.09 1.25-.3 1.81-.624l42.13-24.336a5.1 5.1 0 0 0 2.46-3.476l-46.18-78.89a5.3 5.3 0 0 0-1.03-.102q-.21 0-.42.02" />
      </clipPath>
    </defs>
    <path
      fill="#689f63"
    ...
    <path
      fill="#689f63"
      fillRule="evenodd"
      d="M394.538 105.2a.97.97 0 0 1 .98 0l8.13 4.69c.304.176.49.5.49.85v9.39c0 .35-.186.674-.49.85l-8.13 4.69a.97.97 0 0 1-.98 0l-8.125-4.69a.98.98 0 0 1-.5-.85v-9.39c0-.35.18-.674.49-.85zm0 0"
    />
    <g clipPath="url(#node-js_svg__a)" transform="translate(-78.306 -164.016)">
      <path
        fill="url(#node-js_svg__b)"
        d="m331.363 246.793-118.715-58.19-60.87 124.174L270.49 370.97zm0 0"
      />
    </g>
    <g clipPath="url(#node-js_svg__c)" transform="translate(-78.306 -164.016)">
      <path
        fill="url(#node-js_svg__d)"
        d="m144.07 264.004 83.825 113.453 110.86-81.906-83.83-113.45zm0 0"
      />
    </g>
    <g clipPath="url(#node-js_svg__e)" transform="translate(-78.306 -164.016)">
      <path
        fill="url(#node-js_svg__f)"
